...
function registerController(){
    async function post(req, res){
        ...
        try{
            ...
            let registeredData = await connection.db.collection('register').insertOne(users_Data)
    ...
    function validate(req, res, next){
     ...
     async function update(req, res){
        try{
            ...
            let registeredData = await connection.db.collection('register').updateOne({_id: id2}, { $set: { data }})
    ...
    async function get(req, res){
        try{
            ...
            const data = await connection.db.collection('register').find( {_id:id} );
    ...
    async function getAllData(req, res){
        try{
            const data = await connection.db.collection('register').find( {} );
            const items = await data.toArray()
            // for temporal usage
    ...
    async function deleteStaff(req, res){
        try{
            ...
            const data = await connection.db.collection('register').deleteOne( {_id: id} );
